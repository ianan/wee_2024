pro do_wee_fit_2024_vth71_bpow
  ...
  ; Use current OSPEX f_vth CHIANTI which is V9.01, here doing v7.1
;  chianti_kev_common_load,contfile=getenv('CHIANTI_CONT_FILE') ,linefile=getenv('CHIANTI_LINES_FILE'),/reload
  ...
  for i=0,nf-1 do begin
    ...
    if (i mod 50 eq 0) then savegen,file='wee_2024_vth71_bpow.genx',resout
;    close,/all,/force
;    heap_gc
  endfor
  
  savegen,file='wee_2024_vth71_bpow.genx',resout
