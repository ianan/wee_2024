pro do_wee_fit_2024_vth11_t101_tt
  ...
  ; Use the new v11 with 101 bins
  chianti_kev_common_load, contfile = 'chianti_cont_1_250_unity_v1102_t101.sav', linefile = 'chianti_lines_1_12_unity_v1102_t101.sav', /reload
  fit_mod = 'vth11(t101)+tt'
  ...
  for i = 0, nf - 1 do begin
    ...
    if (i mod 50 eq 0) then savegen, file = 'wee_2024_vth11_t101_tt.genx', resout
    ; close,/all,/force
    ; heap_gc
  endfor

  savegen, file = 'wee_2024_vth11_t101_tt.genx', resout
