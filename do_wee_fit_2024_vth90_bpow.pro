pro do_wee_fit_2024_vth90_bpow
  ...
  ; Use current OSPEX f_vth CHIANTI which is V9.01
;  chianti_kev_common_load,contfile=getenv('CHIANTI_CONT_FILE') ,linefile=getenv('CHIANTI_LINES_FILE'),/reload
  chianti_kev_common_load,contfile='chianti_cont_01_250_unity_v901.geny',linefile='chianti_lines_07_12_unity_v901_t41.geny',/reload
  fit_mod='vth90+bpow'
  ...
  for i=0,nf-1 do begin
    ...
    if (i mod 50 eq 0) then savegen,file='wee_2024_vth90_bpow.genx',resout
;    close,/all,/force
;    heap_gc
  endfor
  
  savegen,file='wee_2024_vth90_bpow.genx',resout
